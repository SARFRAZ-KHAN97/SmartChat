...
function Profile(props) {
  ...
  return (
    <div className='bg-background w-[30vw]'> 
      <div className='bg-green-400 text-white py-4 text-lg px-4 flex items-center gap-4'>
          <button
        ...
        <div className='flex flex-col items-center justify-center gap-8 mt-8'>
          <label className={`group relative cursor-pointer rounded-full overflow-hidden ${isUploading ? "pointer-events-none" : ""}`}>
            <img src={userData.profile_pic || "/defaultUser.png"} 
              alt="profile_pic" className='w-[160px] h-[160px] object-cover' 
            />
            {isUploading ? (
              <div className='absolute inset-8 flex items-center justify-center bg-black/10 z-10'>
          ...
          <div className='flex flex-col bg-white w-full py-4 px-8'>
            <label className='text-sm text-primary-dense mb-2'>You Name</label>
          ...
          <div className='flex flex-col bg-white w-full py-4 px-8'>
            <label className='text-sm text-primary-dense mb-2'>You Status</label>
              <div className='flex items-center w-ful'>
                <input 
                  value={status}
                  className='w-full bg-transparent'
